...
$fixtures = [
    ...
    [
        'type_id' => 'bundle',
        'sku' => 'klevu_bundle_synctest_instock_childrenoos_notrequired',
        'name' => '[Klevu] Sync Test: Bundle Product: In Stock; Children OOS, Not Required',
        'description' => '[Klevu Test Fixtures]',
        'short_description' => '[Klevu Test Fixtures]',
        'attribute_set_id' => 4,
        'website_ids' => array_filter([
        ...
        'url_key' => 'klevu_bundle_synctest_instock_childrenoos_notrequired_' . crc32(rand()),
        'price_type' => BundlePrice::PRICE_TYPE_DYNAMIC,
        'child_skus' => [
            'klevu_simple_synctest_bundlechild_oos',
        ],
    ...
    $product->setBundleOptionsData(
        [
            [
                ...
                'type' => 'select',
                'required' => $fixture['required_children'] ?? 1,
                'delete' => '',
            ],
        ]
    );
