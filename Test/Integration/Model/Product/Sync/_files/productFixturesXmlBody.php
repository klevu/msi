...
$fixtures = [
    ...
    [
        'type_id' => 'simple',
        'sku' => 'klevu_configchild_synctest_xmlbody_oos',
        'name' => '[Klevu] Sync Test: Child Product OOS',
        'description' => '[Klevu Test Fixtures]',
        'short_description' => '[Klevu Test Fixtures]',
        'attribute_set_id' => 4,
        'website_ids' => array_filter([
        ...
        'url_key' => 'klevu_configchild_synctest_xmlbody_oos_' . crc32(rand()),
        'klevu_test_configurable' => $configurableAttributeOptions[4]->getValue(),
        'klevu_boolean_attribute' => 1,
    ],
    [
        'type_id' => 'simple',
        'sku' => 'klevu_configchild_synctest_xmlbody_instock',
        'name' => '[Klevu] Sync Test: Child Product In Stock',
        'description' => '[Klevu Test Fixtures]',
        'short_description' => '[Klevu Test Fixtures]',
        'attribute_set_id' => 4,
        'website_ids' => array_filter([
        ...
        'url_key' => 'klevu_configchild_synctest_xmlbody_instock_' . crc32(rand()),
        'klevu_test_configurable' => $configurableAttributeOptions[4]->getValue(),
        'klevu_boolean_attribute' => 1,
    ],
    [
        'type_id' => 'configurable',
        'sku' => 'klevu_config_synctest_xmlbody_instock_child_oos',
        'name' => '[Klevu] Sync Test: Configurable Product In Stock Child OOS',
        'description' => '[Klevu Test Fixtures]',
        'short_description' => '[Klevu Test Fixtures]',
        'attribute_set_id' => 4,
        'website_ids' => [
        ...
        'url_key' => 'klevu_config_synctest_xmlbody_instock_child_oos_' . crc32(rand()),
        'child_skus' => [
    ...
    [
        'type_id' => 'configurable',
        'sku' => 'klevu_config_synctest_xmlbody_instock_childinstock',
        'name' => '[Klevu] Sync Test: Configurable Product In Stock Child In Stock',
        'description' => '[Klevu Test Fixtures]',
        'short_description' => '[Klevu Test Fixtures]',
        'attribute_set_id' => 4,
        'website_ids' => [
        ...
        'url_key' => 'klevu_config_synctest_xmlbody_instock_childinstock_' . crc32(rand()),
        'child_skus' => [
...
// Move inventory to none default stock
if (!empty($skus)) {
    try {
        ...
        $bulkAssign = $objectManager->create(BulkSourceAssignInterface::class);
        $bulkAssign->execute($skus, $sources);

        $bulkTransfer = $objectManager->create(BulkInventoryTransfer::class);
        $bulkTransfer->execute($skus, 'default', $source->getId(), false);
    } catch (\Magento\Framework\Exception\NoSuchEntityException $e) {
        // this is fine, source does not exist. persist with default
    }
}
