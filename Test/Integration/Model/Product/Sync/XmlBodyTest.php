...
namespace Klevu\Msi\Test\Integration\Model\Product\Sync;
...
class XmlBodyTest extends TestCase
{
    ...
    public function testConfigurableProduct_OutOfStock(): void
    {
        ...
        $expectedPairs = [
            ...
            '<key>sku</key><value>klevu_config_synctest_xmlbody_instock_child_oos;;;;klevu_configchild_synctest_xmlbody_oos</value>', // phpcs:ignore Generic.Files.LineLength
            '<key>image</key><value/>',
            '<key>small_image</key><value/>',
            '<key>media_gallery</key><value><images/><values/></value>',
            '<key>status</key><value><label>Enable Product</label><values>Enabled</values></value>',
    ...
    public function testConfigurableProduct_InStock(): void
    {
        ...
        $expectedPairs = [
            ...
            '<key>sku</key><value>klevu_config_synctest_xmlbody_instock_childinstock;;;;klevu_configchild_synctest_xmlbody_instock</value>', // phpcs:ignore Generic.Files.LineLength
            '<key>image</key><value/>',
            '<key>small_image</key><value/>',
            '<key>media_gallery</key><value><images/><values/></value>',
            '<key>status</key><value><label>Enable Product</label><values>Enabled</values></value>',
     ...
     * @return null
     */
    private function assertStringContainsStringBackCompat(string $needle, string $haystack, string $message = '')
    {
